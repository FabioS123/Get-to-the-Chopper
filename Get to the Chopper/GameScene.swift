...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if firstBody.categoryBitMask == CollisionBitMask.chopperCategory && secondBody.categoryBitMask == CollisionBitMask.wallCategory || firstBody.categoryBitMask == CollisionBitMask.wallCategory && secondBody.categoryBitMask == CollisionBitMask.chopperCategory || firstBody.categoryBitMask == CollisionBitMask.chopperCategory && secondBody.categoryBitMask == CollisionBitMask.groundCategory || firstBody.categoryBitMask == CollisionBitMask.groundCategory && secondBody.categoryBitMask == CollisionBitMask.chopperCategory{
            ...
            if firstBody.categoryBitMask == CollisionBitMask.chopperCategory && secondBody.categoryBitMask == CollisionBitMask.wallCategory || firstBody.categoryBitMask == CollisionBitMask.wallCategory && secondBody.categoryBitMask == CollisionBitMask.chopperCategory {
                
                if let particles = SKEmitterNode(fileNamed: "SmokeParticle.sks") {
                    particles.particleScale = 0.3
                    particles.position = self.chopper.position
                    self.addChild(particles)
                }
            }
            
            if firstBody.categoryBitMask == CollisionBitMask.chopperCategory && secondBody.categoryBitMask == CollisionBitMask.groundCategory || firstBody.categoryBitMask == CollisionBitMask.groundCategory && secondBody.categoryBitMask == CollisionBitMask.chopperCategory {
